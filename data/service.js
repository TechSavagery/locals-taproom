...
export const approachContenttwo = [
  {
    id: 7,
    title: "Partnership",
...
export const serviceContent = [
  {
    ...
    titlePart1: "LOCAL",
    titlePart2: "DELIGHTS",
    descriptions: `Outside food welcome! We've also partnered with Mission Pizza, conveniently located across the street, so you can recieve 10% OFF when you dine at Local's Taproom!`,
  },
  {
    id: 12,
    icon: "lnil lnil-record",
    titlePart1: "VINYL",
    titlePart2: "VIBES",
    descriptions: ` Step into a world where the warm crackle of vinyl sets the mood. Our patrons are encouraged to request their favorite tunes, crafting an atmosphere that's uniquely theirs with every visit..`,
  },
  {
    id: 13,
    icon: "lnil lnil-sun",
    titlePart1: "SCENIC",
    titlePart2: "SEATING",
    descriptions: ` Choose your perfect spot in our indoor or outdoor seating areas. Inside, enjoy the cozy ambiance, or step outside to soak in the stunning beach views that Avila Beach, CA, is famous for.`,
  },
];
...
export const serviceContentfour = [
  {
    delayAnimation: "200",
    serviceList: [
      { id: 31, name: "Branding" },
...
export const allserviceContent = [
  ...approachContent,
  ...approachContenttwo,
  ...serviceContent,
  ...serviceContenttwo,
